...
public class UploadServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String department = request.getParameter("dept");//Textbox value of name firstname.
            String semester = request.getParameter("sem");//Textbox value of name lastname.
            ...
            try {
                ...
                String sql = "insert into materials(department,semester,subject,book,path,added_date) values(?,?,?,?,?,?)";
